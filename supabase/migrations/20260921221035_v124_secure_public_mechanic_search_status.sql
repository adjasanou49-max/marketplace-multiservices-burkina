...
revoke all on function public.get_public_mechanics() from public;
revoke all on function public.get_public_mechanics() from anon;
grant execute on function public.get_public_mechanics() to authenticated;
