...
Les runners Android et iOS officiels Flutter 3.47.x sont maintenant versionnés dans `android/` et `ios/`. Android est préparé pour Play Store/AAB, avec permissions localisation/notifications et signature Release conditionnelle. iOS est préparé pour iOS 15, APNs et deep linking. Un workflow natif compile automatiquement Android et iOS.
